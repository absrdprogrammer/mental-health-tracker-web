    ...
    <div class="form-container">
        ...
        <div class="col col-2">
            ...
            <div class="login-form">
                ...
                <form action="<?php echo base_url('auth_admin/login'); ?>" method="post" class="form-inputs">
                    <div class="input-box">
            ...
            <div class="register-form">
                ...
                <form action="<?php echo base_url('auth_admin/register'); ?>" method="post" class="form-inputs">
                    <div class="input-box">
